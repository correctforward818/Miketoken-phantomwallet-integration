...
export const addSerializedToken = createAction<{
  serializedToken: SerializedWrappedToken;
...
export const updateUserLimitOrderAcceptedWarning = createAction<{
  userAcceptedRisk: boolean;
...
export const updateWalletType = createAction<{ type: string }>(
  "user/updateWalletType"
);
export const updateSolanaAddress = createAction<{ address: string }>(
  "user/updateSolanaAddress"
);
...
export const hidePhishingWarningBanner = createAction<void>(
  "user/hidePhishingWarningBanner"
);

export const setIsExchangeChartDisplayed = createAction<boolean>(
  "user/toggleIsExchangeChartDisplayed"
);
export const setChartViewMode = createAction<ChartViewMode>(
  "user/setChartViewMode"
);
